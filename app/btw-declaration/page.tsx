        ...
        <div className="flex justify-between items-start">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground mt-1">Quarterly VAT Declaration - Ready for Filing</p>
            </div>
          </div>
          <Button
            variant="outline"
        ...
        {!quarterData && (
          <Card className="bg-card border-border">
            <CardContent className="p-12 text-center">
              <p className="text-muted-foreground">No data available for {selectedYear} Q{selectedQuarter}</p>
            </CardContent>
          </Card>
        )}
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <Card className="bg-secondary border-border">
                <CardHeader>
                  <CardTitle className="text-primary text-sm font-medium">Total VAT Collected</CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card className={quarterData.net_vat_to_pay > 0 ? 'bg-red-600 border-red-600' : 'bg-green-600 border-green-600'}>
                ...
                <CardContent>
                  ...
                  {quarterData.status === 'settled' && (
                    <Badge variant="outline" className="mt-2 bg-card/20 text-white border-white/40">Settled</Badge>
                  )}
                </CardContent>
              </Card>
            </div>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="border-l-4 border-blue-600 pl-6 py-4 bg-blue-50 rounded-r-lg">
                  <div className="flex justify-between items-start mb-3">
                    ...
                    <Badge className="bg-primary">High Rate</Badge>
                  </div>
                  <div className="grid grid-cols-2 gap-4 mt-4">
                    <div className="bg-card p-4 rounded-lg">
                      <p className="text-sm text-muted-foreground mb-1">Omzet (excl. BTW)</p>
                      <p className="text-2xl font-bold text-foreground">€{quarterData.high_rate_revenue.toFixed(2)}</p>
                    </div>
                    <div className="bg-card p-4 rounded-lg">
                      <p className="text-sm text-muted-foreground mb-1">BTW (21%)</p>
                      <p className="text-2xl font-bold text-primary">€{quarterData.high_rate_vat_collected.toFixed(2)}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="border-l-4 border-green-600 pl-6 py-4 bg-green-50 rounded-r-lg">
                  ...
                  <div className="grid grid-cols-2 gap-4 mt-4">
                    <div className="bg-card p-4 rounded-lg">
                      <p className="text-sm text-muted-foreground mb-1">Omzet (excl. BTW)</p>
                      <p className="text-2xl font-bold text-foreground">€{quarterData.low_rate_revenue.toFixed(2)}</p>
                    </div>
                    <div className="bg-card p-4 rounded-lg">
                      <p className="text-sm text-muted-foreground mb-1">BTW (9%)</p>
                ...
                <div className="border-l-4 border-orange-600 pl-6 py-4 bg-orange-50 rounded-r-lg">
                  ...
                  <div className="bg-card p-4 rounded-lg">
                    <p className="text-sm text-muted-foreground mb-1">Omzet & BTW</p>
                    <p className="text-2xl font-bold text-foreground">€0.00</p>
                    <p className="text-xs text-muted-foreground mt-2">Not applicable for this period</p>
                  </div>
                </div>
                ...
                <div className="border-l-4 border-purple-600 pl-6 py-4 bg-purple-50 rounded-r-lg">
                  ...
                  <div className="bg-card p-4 rounded-lg">
                    <p className="text-sm text-muted-foreground mb-1">BTW over privégebruik</p>
                    <p className="text-2xl font-bold text-foreground">€0.00</p>
                    <p className="text-xs text-muted-foreground mt-2">Fill this in Q4 only</p>
                  </div>
                </div>

                {/* Question 1e: Zero Rate or Not Taxed */}
                <div className="border-l-4 border-slate-600 pl-6 py-4 bg-background rounded-r-lg">
                  <div className="flex justify-between items-start mb-3">
                    <div>
                      <h3 className="font-bold text-foreground text-lg">1e. Leveringen/diensten belast met 0% of niet bij u belast</h3>
                      <p className="text-sm text-foreground mt-1">Zero-rated or reverse charge supplies</p>
                    </div>
                    <Badge variant="outline">0% / Reverse</Badge>
                  </div>
                  <div className="bg-card p-4 rounded-lg">
                    <p className="text-sm text-muted-foreground mb-1">Omzet (0% tarief)</p>
                    <p className="text-2xl font-bold text-foreground">€{quarterData.zero_rate_revenue.toFixed(2)}</p>
                    <p className="text-xs text-muted-foreground mt-2">Includes exports & reverse charge</p>
                  </div>
                </div>
                ...
                <div className="border-l-4 border-indigo-600 pl-6 py-4 bg-indigo-50 rounded-r-lg">
                  ...
                  <div className="grid grid-cols-2 gap-4 mt-4">
                    <div className="bg-card p-4 rounded-lg">
                      <p className="text-sm text-muted-foreground mb-1">Omzet</p>
                      <p className="text-2xl font-bold text-foreground">€0.00</p>
                      <p className="text-xs text-muted-foreground mt-2">Not tracked separately yet</p>
                    </div>
                    <div className="bg-card p-4 rounded-lg">
                      <p className="text-sm text-muted-foreground mb-1">BTW (verlegd)</p>
                      <p className="text-2xl font-bold text-indigo-900">€0.00</p>
                      <p className="text-xs text-muted-foreground mt-2">Deductible at 5b</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="border-t-2 border-border pt-6 mt-6">
                  <h2 className="text-xl font-bold text-foreground mb-4">Rubriek 3: Prestaties naar het buitenland</h2>
                </div>
                ...
                <div className="border-l-4 border-cyan-600 pl-6 py-4 bg-cyan-50 rounded-r-lg">
                  ...
                  <div className="bg-card p-4 rounded-lg">
                    ...
                    <p className="text-xs text-muted-foreground mt-2">Based on client country</p>
                  </div>
                </div>
                ...
                <div className="border-l-4 border-teal-600 pl-6 py-4 bg-teal-50 rounded-r-lg">
                  ...
                  <div className="bg-card p-4 rounded-lg">
                    <p className="text-sm text-muted-foreground mb-1">Omzet</p>
                    <p className="text-2xl font-bold text-foreground">€0.00</p>
                    <p className="text-xs text-muted-foreground mt-2">Not applicable for services</p>
                  </div>
                </div>

                {/* Section 4: Prestaties vanuit het buitenland */}
                <div className="border-t-2 border-border pt-6 mt-6">
                  <h2 className="text-xl font-bold text-foreground mb-4">Rubriek 4: Prestaties vanuit het buitenland aan u verricht</h2>
                </div>
                ...
                <div className="border-l-4 border-amber-600 pl-6 py-4 bg-amber-50 rounded-r-lg">
                  ...
                  <div className="grid grid-cols-2 gap-4 mt-4">
                    ...
                    <div className="bg-card p-4 rounded-lg">
                      <p className="text-sm text-muted-foreground mb-1">BTW</p>
                      <p className="text-2xl font-bold text-amber-900">
                        €{(quarterData.imports_non_eu_vat || 0).toFixed(2)}
                      </p>
                    </div>
                  </div>
                  <p className="text-xs text-muted-foreground mt-2">Based on supplier country</p>
                </div>
